...
My focus is on building scalable, execution-driven marketing processes using tools like LLMs, automation platforms, and no-code/low-code solutions.
...
* Reduced manual effort in ideation and drafting
...
1. Generate relevant prompts based on persona and use cases
2. Send prompts to multiple LLMs:

   * ChatGPT
   * Perplexity
   * Gemini
3. Collect and analyze responses
4. Detect brand mentions and position within responses

**Output:**

* Ranking of brand appearances per prompt
* Visibility score
...
* Understand if they appear in AI-generated answers
* Evaluate competitive positioning
* Optimize content strategies for LLM visibility (GEO/AEO)
...
* End-to-end growth systems powered by automation

---

## 🤝 Let’s Connect

I’m interested in roles and projects where I can combine marketing, AI, and automation to build scalable growth systems.

Feel free to reach out or explore the projects in this repository.
